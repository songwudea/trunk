...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
				...
				<table  width="100%" height="138" border="0" cellpadding="0" cellspacing="0">
					<tr><td height="6" valign="top"></td></tr>
						<tr>
							<td>
								<table class="table-table" width="95%" height="31" border="0" cellpadding="0" cellspacing="0">
									<tr align="center"><td class="left_bt2" colspan="11" align="left"><font color="#FF0000">第一步 确认收货信息及交易详情</font></td></tr>
						...
						<tr>
							<td>
								<table class="table-table" width="95%" height="31" border="0" cellpadding="0" cellspacing="0">
									<tr align="center"><td class="left_bt2" colspan="11" align="left"><font color="#FF0000">第二步 确认发货信息</font></td></tr>
									<tr><td class="left_bt2" align="left">我的发货信息：${orderDispatch.shipcity}${orderDispatch.shipregion}${orderDispatch.shipaddress}， ${orderDispatch.shipzip}，${orderDispatch.shipname}， ${orderDispatch.shiptel} </td></tr>
								</table>
							</td>
						</tr>
						<tr><td height="30" align="center"></td></tr>
						<tr>
							<td>
								<form method="post" name="form" action="${ctx}/admin/orderdispatch/confirmDispatch.html" onsubmit="return checkForm(this)">
								<input type="hidden" value="${orderDispatch.orderNumber}" id= "orderNumber" name="orderNumber"/>
								<table class="table-table" width="95%" height="31" border="0" cellpadding="0" cellspacing="0">
									<tr align="center"><td class="left_bt2" colspan="11" align="left"><font color="#FF0000">第三步  选择物流服务</font></td></tr>
									<tr><td class="left_bt2" align="left">物流选择：
									...
									<tr>
										<td align="left">
											<button type="submit" style="padding:3px 10px;">确认</button>
										</td>
									</tr>
			...
			<tr>
				<td height="30" align="left"><a href="${ctx}/admin/orderdispatch">返回列表页</a></td>
			</tr>						
					</table>
				</td>
			<td>&nbsp;</td>
