...
public class OrderDispatchService {
	...
	public OrderDispatch getOrderDispatchById(Integer id) {
		return orderDispatchDao.getByPK(id);
	}
	
	/**
	 * 根据 ordernumber查找发货单明细
	 * @param orderNumber
	 * @return
	 */
	public List<OrderDispatchDetail> findOrderDispatchDetailByOrderNumber(Integer orderDispathId) {
		return orderDispatchDetailDao.findOrderDispatchDetailByOrderDispathId(orderDispathId);
	}
	
	public Page<OrderDispatch> list(Page<OrderDispatch> page, OrderDispatch orderDispatch, Integer siteId) {
		return orderDispatchDao.findOrderDispatchPage(page, orderDispatch, siteId);
	} 
	
	public OrderDispatch getOrderDispatchByOrderNumber(String orderNumber) {
		return orderDispatchDao.getOrderDispatchByOrderNumber(orderNumber);
	}
	
	public void updateStatus(String orderNumber, OrderDispatchEnum orderDispatchEnum) {
		orderDispatchDao.updateStatus(orderNumber, orderDispatchEnum);
	}
