...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("/admin/template/list.html',  \n");
      ...
      out.write("    \t\ttoolbar:[{\n");
      out.write("\t        \ttext:'首页模版配置',  \n");
      out.write("\t         \ticonCls:'icon-add',\n");
      out.write("\t         \tplain:true,\n");
      out.write("\t         \thandler:function() {\n");
      out.write("\t         \t\tvar row = $('#tt').datagrid('getSelected');\n");
      out.write("\t         \t\tif(row == null) {\n");
      out.write("\t         \t\t\talert('请选择模版');\n");
      out.write("\t         \t\t} else {\n");
      out.write("\t\t         \t\tdocument.location.href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/admin/template/confighomepage.html?templateId=\" + row.id + \"&pageType=Page\";\n");
      out.write("\t         \t\t}\n");
      out.write("\t         \t\t\n");
      out.write("\t         \t}\n");
      out.write("     \t\t},{\n");
      out.write("\t        \ttext:'分类模版配置',  \n");
      out.write("\t         \ticonCls:'icon-add',\n");
      out.write("\t         \tplain:true,\n");
      out.write("\t         \thandler:function() {\n");
      out.write("\t         \t\tvar row = $('#tt').datagrid('getSelected');\n");
      ...
      out.write("\t\t         \t\tdocument.location.href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/admin/template/confighomepage.html?templateId=\" + row.id + \"&pageType=Category\";\n");
      out.write("\t         \t\t}\n");
      out.write("\t         \t}\n");
      out.write("     \t\t}],\n");
      out.write("\t     \tcolumns:[[  \n");
      out.write("\t        \t{field:'id',title:'',width:60, checkbox:true},\n");
      out.write("\t        \t{field:'name',title:'名称',width:60},\n");
      out.write("\t        \t{field:'path',title:'路径',width:60}\n");
      out.write("\t    \t]]  \n");
      out.write("\t\t}); \n");
      out.write("\t\t\n");
