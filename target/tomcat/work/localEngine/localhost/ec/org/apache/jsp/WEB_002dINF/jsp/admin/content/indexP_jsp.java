package org.apache.jsp.WEB_002dINF.jsp.admin.content;
...
public final class indexP_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("/admin/content/edit.html?parentId=0\";\n");
      out.write("\t         \t}\n");
      out.write("     \t\t },{  \n");
      out.write("\t        \ttext:'修改',  \n");
      out.write("\t         \tplain:true,\n");
      ...
      out.write("\t         \t\tdocument.location.href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/admin/content/edit.html?id=\" + row.id;\n");
      out.write("\t         \t}\n");
      out.write("     \t\t },{\n");
      out.write("     \t\t\tid:'btndel',\n");
      out.write("\t\t\t\ttext:'删除',\n");
      ...
      out.write("\t\t\t\t\tvar row = $('#tt').datagrid('getSelected');\n");
      out.write("\t\t\t\t\tif (row) {\n");
      out.write("\t\t\t\t\t\t$.messager.confirm('确认删除', '删除目录后将不可恢复），你确定要这样做吗?', function(r){\n");
      out.write("\t\t\t\t\t\tif(r) {\n");
      out.write("\t                \t\t$.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/admin/content/delete.html',{id:row.id},function(data){\n");
      ...
      out.write("\t\t\turl:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/admin/content/list.html',  \n");
      ...
      out.write("\t        \t{field:'title',title:'类型名称',width:100,\n");
      out.write("\t        \t\tformatter:function(value,rowData)\n");
      out.write("\t        \t\t{\n");
      out.write("\t        \t\t\treturn \"<a href='");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/admin/content/list2.html?parentId=\"+rowData.id+\"'>\"+value+\"</a>\";\n");
      out.write("\t        \t\t}\n");
      out.write("\t        \t}\n");
      out.write("\t    \t]]  \n");
      out.write("\t\t}); \n");
