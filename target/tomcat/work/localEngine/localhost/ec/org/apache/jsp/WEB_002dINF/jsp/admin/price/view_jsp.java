package org.apache.jsp.WEB_002dINF.jsp.admin.price;
...
public final class view_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t    \tvar prices = eval($('#price').val());\n");
      out.write("\t    \t$.each(prices,function(n,price) {\n");
      out.write("\t    \t\tvar dom = \"<div>\";\n");
      out.write("\t\t\t\tdom += \"<label>价格区间</label><input type='text' size='8' class='input' name='rangeMins' value='\" + price.rangeMin  +\"'>到<input type='text' size='8' class='input' name='rangeMaxs' value='\" + price.rangeMax  +\"'><a onclick='delSpec(this)' href='javascript:;'>[-]</a>\";\n");
      out.write("\t\t\t\tdom += \"</div>\";\n");
      out.write("\t    \t\t\n");
      out.write("\t    \t\t$(\"fieldset\").append(dom);\n");
      out.write("       \t\t});\n");
      out.write("    \t});\n");
      out.write("    \n");
      out.write("    \n");
      ...
      out.write("\t\t\tvar dom = \"<div>\";\n");
      out.write("\t\t\tdom += \"<label>价格区间</label><input type='text' size='8' class='input' name='rangeMins'>到<input type='text' size='8' class='input' name='rangeMaxs'><a onclick='delSpec(this)' href='javascript:;'>[-]</a>\";\n");
      out.write("\t\t\tdom += \"</div>\";\n");
      out.write("\t\t\t$(\"fieldset\").append(dom);\n");
      out.write("\t\t}\n");
      out.write("\t\t\n");
      ...
      out.write("/admin/price/edit.html\">\n");
      ...
      out.write(" />\n");
      out.write("\t\t<input type=\"hidden\" id=\"siteId\" name=\"siteId\" value=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${siteId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write(" />\n");
      out.write("\t\t<fieldset>\n");
      out.write("\t\t\t<legend>价格区间</legend> \n");
      out.write("\t\t\t<div>\n");
      out.write("\t\t\t\t<label>价格区间</label>\n");
      out.write("\t\t\t\t<input type=\"button\" name=\"add\" id=\"add\" value=\"添加\" onclick=\"addSpec(this);\" />\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</fieldset>\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/admin/price/view.jsp(34,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
