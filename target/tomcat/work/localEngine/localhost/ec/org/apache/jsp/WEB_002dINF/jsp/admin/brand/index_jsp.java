package org.apache.jsp.WEB_002dINF.jsp.admin.brand;
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("/admin/brand/edit.html\";\n");
      out.write("\t         \t}\n");
      out.write("     \t\t },{  \n");
      out.write("\t        \ttext:'修改',  \n");
      out.write("\t         \tplain:true,\n");
      ...
      out.write("\t         \t\t\talert('请选中一个品牌');\n");
      out.write("\t         \t\t} else {\n");
      out.write("\t\t         \t\tdocument.location.href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/admin/brand/edit.html?brandId=\" + row.id;\n");
      out.write("\t         \t\t}\n");
      out.write("\t         \t\t\n");
      out.write("\t         \t}\n");
      out.write("     \t\t },{\n");
      ...
      out.write("\t                \t\t$.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/admin/brand/delete.html',{id:row.id},function(data){\n");
      ...
      out.write("\t     \tcolumns:[[  \n");
      out.write("\t        \t{field:'name',title:'品牌名称',width:90},\n");
      out.write("\t        \t{field:'sorts',title:'顺序',width:60},\n");
      out.write("\t        \t{field:'hide',title:'状态',width:60,formatter:function(value){return value==\"\" ?'显示':'隐藏';}}\n");
      out.write("\t    \t]]  \n");
      out.write("\t\t}); \n");
      out.write("\t\t\n");
