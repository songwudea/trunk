...
<c:if test="${item.inventory != 0}">
    ...
    <a href="javascript:;"  class="minus"><img src="images/jian.jpg" width="13" height="13" / align="left"></a>
<dd class=it>
  <input class="border" onchange=keychk_num() id="qty" value="1"
  name="qty" />
</dd>
    <dd>件 </dd>
    <a href="javascript:;" class="plus"><img src="images/jia.jpg" width="13" height="13" /></a>
  </div>
         </div>  
          <div class="btn">
  ...
  <li class="cur" ><span>商品详情</span> </li>
	<%--li><span>售后服务</span></li--%>
       ...
       <div id="description">
             ...
             <div class="comment"><img src="images/kb.jpg" width="298" height="31" /></div>
